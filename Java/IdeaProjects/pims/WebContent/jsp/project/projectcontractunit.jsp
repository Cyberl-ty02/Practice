    ...
    <script type="text/javascript">
        ...
        $(function () {
	    	...
	    	$("#print").click(function () {	    		
	    		$("#fm").attr("action","ProjectContractService?caozuo=print&con="+getcon());
    			$("#fm").submit();
	    	});
	    	//下载文件成功提示
	    	$('#fm').form({
     ...
     <div style="height:96%;">
	 	 ...
	 	 <table id="info" class="easyui-datagrid" width="100%" style="height:100%;" border="0" cellpadding="0" cellspacing="0" 
	    	...
	    	<thead>
	    		<tr>
					...
					<th data-options="field:'price',width:120,align:'center'">价  款</th>
	     ...
	     <div id="tb" style="padding:10px;height:auto">
			...
			<div>			   
			    ...
			    &nbsp;&nbsp;<a id="print" class="easyui-linkbutton" iconCls="icon-print" plain="true">输出合同信息</a>							
			</div>
			</div>
		 </div>
	</div>               	             
