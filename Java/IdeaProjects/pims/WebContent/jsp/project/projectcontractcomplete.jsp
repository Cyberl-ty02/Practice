  ...
  <head>
    ...
    <script type="text/javascript">
	    ...
	    function initinfo(){
	    	$("#info").datagrid({                
	             loadMsg: "数据加载中，请等待...",                
	             url: 'ProjectContractService?caozuo=initcomplete&edition='+$("#edition").combobox("getValue")+'&con='+getcon()
            });
	    }
		        ...
		        <tr>
		        	<td>
		        		<table width="100%" border="0" cellpadding="0" cellspacing="0" style="background:url(<%=basePath %>images/general/m_mpbg.gif)">
		                    <tr>
		                        <td id="title_id" class="place" align="left">合同书提交情况</td>       
		                        <td>&nbsp;</td>
	                            <td align="right">&nbsp;</td>
	                            <td width="3">
	 	 ...
	 	 <table id="info" class="easyui-datagrid" width="100%" style="height:100%;" border="0" cellpadding="0" cellspacing="0" 
	    	...
	    	<thead>
	    		<tr>	    			
					...
					<th data-options="field:'unit',width:350,align:'center'">拟发布单位</th>
					<th data-options="field:'edition',width:120,align:'center'">版 本</th>			
					<th data-options="field:'completeunit',width:250,align:'center'">合同已提交单位</th>	
	    		</tr>
	    	</thead>
	     </table>	 
